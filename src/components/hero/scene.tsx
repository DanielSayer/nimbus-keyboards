...
import { Keyboard, type KeyboardRefs } from "../keyboard";
...
function Scene() {
  ...
  useGSAP(() => {
    ...
    mm.add("(prefers-reduced-motion: reduce)", () => {
      ...
      setLightIntensityScalar(1);
      gsap.set(keyboard.position, { x: 0.2, y: -0.5, z: 1.9 });
      gsap.set(keyboard.rotation, { x: 1.6, y: 0.4, z: 0 });
    });
